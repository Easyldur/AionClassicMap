class Location {
    ...
    constructor(preliminary, category) {
        ...
        this.keyIcon = this.key;

        this.layer = L.layerGroup();

        this.onLanguageChanged();
        var iconName = this.keyIcon.replace(/[0-9]/g, '');
        ...
        this.element = $(`<div class="collectible-wrapper" data-help="item" data-type="${this.key}">`)
            ...
            .append($(`<img class="collectible-icon" src="./assets/images/icons/${iconName}.png">`))
            ...
            marker => {
                ...
                var tempMarker = L.marker([marker.lat, marker.lng], {
                    ...
                    icon: new L.DivIcon.DataMarkup({
                        ...
                        html: `<div>
                  <img class="icon" src="assets/images/icons/${iconName}.png" alt="Icon">
