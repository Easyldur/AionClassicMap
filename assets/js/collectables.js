class Collectable {
  ...
  constructor(preliminary) {
    ...
    this.element = $(`<div class="menu-option clickable mobs" data-help="item_category" data-type="${this.key}">`)
      .toggleClass('disabled', !this.onMap)
      .on('click', () => this.onMap = !this.onMap)
      .append($('<span>')
          .append($('<span class="menu-option-text">')
              .addClass(this.key)
              .attr('data-text', `menu.${this.key}`)))
      .translate();
    ...
    this.markers.forEach(marker => {
      ...
      var tempMarker = L.marker([marker.lat, marker.lng], {
        ...
        icon: new L.DivIcon.DataMarkup({
          ...
          html: `<div>
              <img class="icon-named-mob" src="assets/images/icons/named_mob.png" alt="Icon">
